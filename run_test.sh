...
python3 main.py test-infer --test-mode dapi-polyt
python3 main.py test-infer --test-mode average-z_dapi-polyt
...
python3 main.py test-score --test-mode dapi-polyt
python3 main.py test-score --test-mode average-z_dapi-polyt
